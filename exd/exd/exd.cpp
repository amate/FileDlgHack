...
LONG GetWindowLongX( HWND hWnd, int nIndex )
{
...
{
	LPTSTR kls[] = {_T("WorkerW"), _T("ReBarWindow32"), _T("Address Band Root"), _T("msctls_progress32"), _T("ComboBoxEx32"), NULL};
...
{
	LPTSTR kls[] = {_T("WorkerW"), _T("ReBarWindow32"), _T("Address Band Root"), _T("msctls_progress32"), _T("ToolbarWindow32"), NULL};
